...
>
  <head>
    ...
    <title>Data Project - TELOS | Politeknik Caltex Riau </title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
             ...
             <!-- Schedule -->
             <li class="menu-item">
              <a href="shedule" class="menu-link">
...
<div class="card">
  ...
  <div class="card-body">
  <p class="mb-4"> <a href="dataproject_tambah"><button type="button" class="btn btn-primary">Add Project</button></p>
