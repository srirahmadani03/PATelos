...
>
  <head>
    ...
    <title>Schedule - TELOS | Politeknik Caltex Riau</title>
...
<div class="card">
  ...
  <div class="card-body">
  <p class="mb-4"> This page to take a realistic look at scheduling.</p>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <td>
              ...
              <option>A</option>
              <option value="1">B</option></select>
            </td>

            <td>
            <input type="text" class="form-control flatpickr-input" placeholder="YYYY-MM-DD" id="flatpickr-disabled-range" readonly="readonly" fdprocessedid="r7586j">
            </td>
